...
import com.openquartz.cloud.ai.example.manus.recorder.entity.PlanExecutionRecordEntity;
import com.openquartz.cloud.ai.example.manus.recorder.entity.ThinkActRecord;
import com.openquartz.cloud.ai.example.manus.recorder.repository.PlanExecutionRecordRepository;
...
public class RepositoryPlanExecutionRecorder implements PlanExecutionRecorder {
	...
	public void recordActionResult(PlanExecutionParams params) {
		...
		com.openquartz.cloud.ai.example.manus.recorder.entity.ThinkActRecord thinkActRecord = findThinkActRecordInPlan(
