...
//		OllamaApi.FunctionTool.Function function = new OllamaApi.FunctionTool.Function(TOOL_DESCRIPTION, TOOL_NAME,
//				PARAMETERS_JSON);
//		return new OllamaApi.FunctionTool(function);
		return new OllamaApi.ChatRequest.Tool(new OllamaApi.ChatRequest.Tool.Function(TOOL_NAME, TOOL_DESCRIPTION, ModelOptionsUtils.jsonToMap(PARAMETERS_JSON)));
