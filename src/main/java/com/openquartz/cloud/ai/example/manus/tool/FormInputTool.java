...
//import org.springframework.ai.OllamaApi.api.OllamaApi;
...
public class FormInputTool extends AbstractBaseTool<FormInputTool.UserFormInput> {
    ...
    public OllamaApi.ChatRequest.Tool getToolDefinition() {
        ...
        try {
//			OllamaApi.FunctionTool.Function function = new OllamaApi.FunctionTool.Function(getToolDescription(), name,
//					getToolParameters());
//			return new OllamaApi.FunctionTool(function);
            return new OllamaApi.ChatRequest.Tool(new OllamaApi.ChatRequest.Tool.Function(name, getToolDescription(), ModelOptionsUtils.jsonToMap(getToolParameters())));
        } catch (Exception e) {
            log.warn("Failed to load prompt-based tool definition, using legacy configuration", e);
//            OllamaApi.FunctionTool.Function function = new OllamaApi.FunctionTool.Function(LEGACY_DESCRIPTION, name,
//                    LEGACY_PARAMETERS);
//            return new OllamaApi.FunctionTool(function);
            return new OllamaApi.ChatRequest.Tool(new OllamaApi.ChatRequest.Tool.Function(name, LEGACY_DESCRIPTION, ModelOptionsUtils.jsonToMap(LEGACY_PARAMETERS)));
        }
    }
