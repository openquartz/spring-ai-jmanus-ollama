...
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.BrowserRequestVO;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.ClickByElementAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.CloseTabAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.ExecuteJsAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.GetElementPositionByNameAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.GetHtmlAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.GetTextAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.InputTextAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.KeyEnterAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.MoveToAndClickAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.NavigateAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.NewTabAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.RefreshAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.ScreenShotAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.ScrollAction;
import com.openquartz.cloud.ai.example.manus.tool.browser.actions.SwitchTabAction;
