...
import com.openquartz.cloud.ai.example.manus.dynamic.model.exception.AuthenticationException;
import com.openquartz.cloud.ai.example.manus.dynamic.model.exception.NetworkException;
import com.openquartz.cloud.ai.example.manus.dynamic.model.exception.RateLimitException;
import com.openquartz.cloud.ai.example.manus.dynamic.model.model.vo.AvailableModel;
import com.openquartz.cloud.ai.example.manus.dynamic.model.model.vo.ModelConfig;
import com.openquartz.cloud.ai.example.manus.dynamic.model.model.vo.ValidationResult;
...
public class ModelServiceImpl implements ModelService {
	...
	private List<AvailableModel> parseModelsResponse(Map response) {
		...
		// Try to parse standard OllamaApi format: {"data": [...]}
