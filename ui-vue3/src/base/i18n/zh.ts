...
const words: I18nType = {
  ...
  init: {
    ...
    description: '首次使用需要配置 LLM 服务来启用 AI 功能。您可以选择使用阿里云百炼服务或自定义 OllamaApi 兼容的 API 服务。',
    ...
    customMode: '自定义 OllamaApi 兼容服务',
    customModeDesc: '配置任何兼容 OllamaApi API 格式的服务，如 Ollama、LocalAI 等',
    ...
    baseUrlPlaceholder: 'http://localhost:11434 或您的自定义地址',
    baseUrlHint: 'OllamaApi 兼容的 API 基础地址，如 http://localhost:11434',
